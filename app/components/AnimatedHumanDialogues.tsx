...
interface DialogueBubble {
  ...
  delay: number;
  color: string;
  face: string; // emoji for face
  name: string;
  age: number;
}

interface AnimatedHumanDialoguesProps {
  program: string;
  className?: string;
  onClick?: () => void;
}

export default function AnimatedHumanDialogues({ program, className = "", onClick }: AnimatedHumanDialoguesProps) {
